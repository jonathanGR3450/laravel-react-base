...
namespace App\Http\Resources\Datosadicionaleslevantamientocatastral;
 ...
 * )
 */
class DatosadicionaleslevantamientocatastralResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'fecha_visita_predial' => $this->fecha_visita_predial,
            'tipo_documento_reconocedor' => $this->tipo_documento_reconocedor,
            'numero_documento_reconocedor' => $this->numero_documento_reconocedor,
            'primer_nombre_reconocedor' => $this->primer_nombre_reconocedor,
            'segundo_nombre_reconocedor' => $this->segundo_nombre_reconocedor,
            'primer_apellido_reconocedor' => $this->primer_apellido_reconocedor,
            'segundo_apellido_reconocedor' => $this->segundo_apellido_reconocedor,
            'resultado_visita' => $this->resultado_visita,
            'otro_cual_resultado_visita' => $this->otro_cual_resultado_visita,
            'suscribe_acta_colindancia' => $this->suscribe_acta_colindancia,
            'despojo_abandono' => $this->despojo_abandono,
            'estrato' => $this->estrato,
            'otro_cual_estrato' => $this->otro_cual_estrato,
            'lc_predio' => $this->lc_predio,
        ];
    }
}
