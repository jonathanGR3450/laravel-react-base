...
namespace App\Http\Resources\DatosPHCondominio;
 ...
 * )
 */
class DatosPHCondominioResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'area_total_construida' => $this->area_total_construida,
            'area_total_construida_privada' => $this->area_total_construida_privada,
            'area_total_construida_comun' => $this->area_total_construida_comun,
            'numero_torres' => $this->numero_torres,
            'total_unidades_privadas' => $this->total_unidades_privadas,
