...
namespace App\Http\Resources\Construccion;
...
class ConstruccionResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'numero_sotanos' => $this->numero_sotanos,
            'numero_mezanines' => $this->numero_mezanines,
            'numero_semisotanos' => $this->numero_semisotanos,
            'anio_construccion' => $this->anio_construccion,
            'avaluo_construccion' => $this->avaluo_construccion,
            'valor_referencia_construccion' => $this->valor_referencia_construccion,
            'area_construccion' => $this->area_construccion,
            'altura' => $this->altura,
            'observaciones' => $this->observaciones,
            'dimension' => $this->dimension,
            'etiqueta' => $this->etiqueta,
            'relacion_superficie' => $this->relacion_superficie,
            'nivel' => $this->nivel,
