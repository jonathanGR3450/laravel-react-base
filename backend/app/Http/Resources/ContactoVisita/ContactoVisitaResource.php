...
namespace App\Http\Resources\ContactoVisita;
 ...
 * )
 */
class ContactoVisitaResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'segundo_nombre_quien_atendio' => $this->segundo_nombre_quien_atendio,
            'primer_apellido_quien_atendio' => $this->primer_apellido_quien_atendio,
            'segundo_apellido_quien_atendio' => $this->segundo_apellido_quien_atendio,
            'domicilio_notificaciones' => $this->domicilio_notificaciones,
            'celular' => $this->celular,
            'correo_electronico' => $this->correo_electronico,
            'autoriza_notificaciones' => $this->autoriza_notificaciones,
            'lc_datos_adicionales' => $this->lc_datos_adicionales,
        ];
    }
}
