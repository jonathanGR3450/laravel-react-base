...
namespace App\Http\Resources\Derecho;
...
class DerechoResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'interesado_lc_interesado' => $this->interesado_lc_interesado,
            'interesado_lc_agrupacioninteresados' => $this->interesado_lc_agrupacioninteresados,
            'unidad' => $this->unidad,
