        ...
        return [
            "Predio" => [
                [
                    ...
                    "unidad_construccion" => $uebaunit->transform(function ($item) {
                        return [
                            ...
                            "lc_construccion" => [
                                ...
                                'numero_pisos' => $item->unidadConstruccion?->construccion?->numero_pisos,
                                'numero_sotanos' => $item->unidadConstruccion?->construccion?->numero_sotanos,
                                'numero_mezanines' => $item->unidadConstruccion?->construccion?->numero_mezanines,
                                'numero_semisotanos' => $item->unidadConstruccion?->construccion?->numero_semisotanos,
                                'anio_construccion' => $item->unidadConstruccion?->construccion?->anio_construccion,
                                'avaluo_construccion' => $item->unidadConstruccion?->construccion?->avaluo_construccion,
                                'valor_referencia_construccion' => $item->unidadConstruccion?->construccion?->valor_referencia_construccion,
                                'area_construccion' => $item->unidadConstruccion?->construccion?->area_construccion,
                                'altura' => $item->unidadConstruccion?->construccion?->altura,
                                'observaciones' => $item->unidadConstruccion?->construccion?->observaciones,
                                'dimension' => $item->unidadConstruccion?->construccion?->dimension,
                                'etiqueta' => $item->unidadConstruccion?->construccion?->etiqueta,
                                'relacion_superficie' => $item->unidadConstruccion?->construccion?->relacion_superficie,
                                'nivel' => $item->unidadConstruccion?->construccion?->nivel,
                                'comienzo_vida_util_version' => $item->unidadConstruccion?->construccion?->comienzo_vida_util_version,
                                'fin_vida_util_version' => $item->unidadConstruccion?->construccion?->fin_vida_util_version,
                                'espacio_de_nombres' => $item->unidadConstruccion?->construccion?->espacio_de_nombres,
                    ...
                    "interrelacionado" => $this->interrelacionado,
                    "interrelacionado_FMI" => $this->codigo_homologado_fmi,
                    "NUPRE" => $this->nupre,
                    ...
                    "Direccion" => $this->extDireccion->transform(function ($item) {
                        return [
                            ...
                            "Tipo_Direccion" => [
                                ...
                                "ilicode" => $item->tipoDireccion?->ilicode,
                                "dispname" => $item->tipoDireccion?->dispname,
                            ],
                            ...
                            "sector_ciudad" => [
                                "t_id" => $item->sectorCuidad?->t_id,
                                "itfcode" => $item->sectorCuidad?->itfcode,
                                "ilicode" => $item->sectorCuidad?->ilicode,
                                "dispname" => $item->sectorCuidad?->dispname,
                            ],
                            "valor_via_generadora" => $item->valor_via_generadora,
                            "letra_via_generadora" => $item->letra_via_generadora,
