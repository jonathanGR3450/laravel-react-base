...
namespace App\Http\Resources\RicPredioTramiteCatastral;
 ...
 * )
 */
class RicPredioTramiteCatastralResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            't_id' => $this->t_id,
            'tramite_catastral' => $this->ricTramiteCatrastral,
            'predio' => $this->ricPredio,
        ];
    }
}
