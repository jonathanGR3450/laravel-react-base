...
namespace App\Http\Resources\UnidadConstruccion;
 ...
 * )
 */
class UnidadConstruccionResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'altura' => $this->altura,
            'lc_caracteristicasunidadconstruccion' => $this->lc_caracteristicasunidadconstruccion,
            'lc_construccion' => $this->lc_construccion,
