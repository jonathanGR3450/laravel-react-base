...
class GetPredioLocalController extends AppBaseController
{
    /**
     * @OA\Get(
    ...
    public function __invoke(IndexPredioFormRequest $request)
    {
        // try {
            ...
            $predio = LcPredioLocal::when($predial, function ($query) use ($predial) {
            ...
            return $this->sendResponse($predioResource, 'lc predio local obtenido correctamente');
        // } catch (\Exception $e) {
